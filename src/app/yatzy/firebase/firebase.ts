...
// Eigene, BENANNTE Firebase-App nur für "Yatzy". In dieser zusammengelegten
// App laufen mehrere Firebase-Apps parallel (Whiteboard als [DEFAULT],
// Schiffe als 'schiffe', Memory als 'memory', Vier gewinnt als 'connect4' …).
// Der Name 'yatzy' verhindert eine Kollision.
const APP_NAME = 'yatzy';
