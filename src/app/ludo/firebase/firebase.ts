...
// Eigene, BENANNTE Firebase-App nur für "Čovječe, ne ljuti se" (Ludo).
...
// Memory als 'memory', Vier gewinnt als 'connect4', UNO als 'uno' …).
// Der Name 'ludo' verhindert eine Kollision.
const APP_NAME = 'ludo';
